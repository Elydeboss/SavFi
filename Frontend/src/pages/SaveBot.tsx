...
function ChatBot() {
  ...
  return (
    <div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-600 p-4 dark:text-white">
        <div className="w-full max-w-md bg-white dark:bg-gray-700 rounded shadow-lg p-4 flex flex-col">
              ...
              >
                <div
                  className={`px-4 py-2 rounded ${
                    m.from === 'bot'
                      ? 'bg-blue-400 text-blue-900 dark:bg-blue-900 dark:text-blue-300 font-medium'
