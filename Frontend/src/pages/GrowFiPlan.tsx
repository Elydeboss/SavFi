...
export default function GrowFiPlan() {
            ...
            <div className="bg-neutral-50 dark:bg-gray-700 rounded-2xl p-6 mb-6">
              <div className="flex items-start gap-4 mb-6">
                <div className="w-14 h-14 rounded-xl bg-vaultfi-light flex items-center justify-center">
                  <img src={GrowFi} alt="VaultFi Logo" className="" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-1">
                    GrowFi
                  </h2>
                  <p className="text-muted-foreground">Growth plan</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-6 border-t border-[#D0D3D6]">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-[#27B97D]">5%</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground mb-1">
                    Early withdrawals
