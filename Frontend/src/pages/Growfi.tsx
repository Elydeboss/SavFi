  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 bg-[#FFFFFF]">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 md:py-20">
        {/* --- FlexFi Hero Section --- */}
        <section className="bg-[#EAFAF3] p-6 md:p-12 rounded-3xl border-2 border-[#43A047] mb-20">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            {/* Text Content */}
            <div className="max-w-xl text-center lg:text-left">
              <h2 className="text-5xl md:text-6xl font-extrabold text-[#43A047] mb-4 leading-tight">
                Growfi
                <span className="text-blue-500 text-[1.5rem]"> 6%interest</span>
              </h2>
              <p className="inline-block bg-[#D6C8FF] text-[#8A38F5] text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
                6 months saving plan
              </p>
              ...
              <button className="px-8 py-3 bg-[#27B97D] text-white font-bold rounded-full hover:bg-blue-600 transition shadow-lg hover:shadow-xl transform hover:scale-105">
                Get started
              </button>
            </div>
        ...
        <section className="mb-20 bg-white p-6 md:p-12 rounded-xl border border-blue-100">
          ...
          <div className=" space-y-8">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-1">
                <h3 className="text-xl font-semibold text-gray-900">
                  user earn 4% interest at the end of the 3-month period
                </h3>
