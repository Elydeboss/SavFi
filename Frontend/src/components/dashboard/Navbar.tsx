...
const Navbar: React.FC<NavbarProps> = ({ title, profileImage }) => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0  md:left-65 md:h-[88px] lg:left-[332px] flex flex-col md:flex-row items-start md:items-center justify-between px-3 md:px-4 lg:px-10 py-4 bg-neutral-50 gap-2 md:gap-4 dark:bg-neutral-800 dark:text-white">
