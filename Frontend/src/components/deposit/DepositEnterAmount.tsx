...
export default function DepositEnterAmount({
  ...
  return (
    <div className="bg-neutral-50 dark:bg-gray-900 ">
      <button
        className="py-5 pl-2 text-muted-foreground text-medium  flex items-center cursor-pointer"
        onClick={() => onCancel?.()}
      >
        <ChevronLeft /> Back
      </button>
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full h-11 rounded-full bg-blue text-white font-semibold disabled:opacity-60 cursor-pointer flex items-center justify-center "
                disabled={!isValid}
              >
                Continue <ChevronRight className="" />
              </button>
